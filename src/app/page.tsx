...
export default function Home() {
  ...
  const handleCopyEmail = () => {
    navigator.clipboard.writeText("harms1390@gmail.com").then(() => {
      setCopySuccess(true);
      setTimeout(() => setCopySuccess(false), 2000); // Hide popup after 2 seconds
    });
  };

  return (
    <div className="min-h-screen bg-gradient-to-b from-indigo-800 via-indigo-900 to-purple-600 text-gray-100 font-sans">
      {/* Hero section */}
      <div className="flex flex-col items-center justify-center min-h-screen p-10 text-center">
        <motion.div
          ...
          className="bg-indigo-900/50 backdrop-blur-md p-10 rounded-2xl shadow-xl border border-indigo-700 max-w-2xl"
        >
          <Image
            src="/profile-pic.jpg"
            alt="Profile"
      ...
      >
        ...
        <div className="grid md:grid-cols-3 gap-10">
          ...
          <div className="bg-indigo-900/30 backdrop-blur-md p-6 rounded-lg shadow-md">
          ...
          <div className="bg-indigo-900/30 backdrop-blur-md p-6 rounded-lg shadow-md">
            ...
            <a href="https://github.com/harman1390/Voting-Hardhat" target="_blank" rel="noopener noreferrer">
              <button className="mt-4 px-4 py-2 border border-indigo-400 text-indigo-300 rounded hover:bg-indigo-800">
                VIEW PROJECT
              </button>
            </a>
      ...
      <motion.div
        ...
        className="py-16 px-8 text-center"
      >
        <h2 className="text-4xl font-bold text-indigo-100 mb-8">Education</h2>
        <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-10">
          <div className="bg-indigo-900/30 backdrop-blur-md rounded-lg shadow-lg p-6 border border-indigo-300">
            <h3 className="text-xl font-semibold text-indigo-200">George Brown College</h3>
            <p className="text-gray-300">Graduate Certificate in Blockchain Development (2022–2023)</p>
          ...
          <div className="bg-indigo-900/30 backdrop-blur-md rounded-lg shadow-lg p-6 border border-indigo-300">
            <h3 className="text-xl font-semibold text-indigo-200">Guru Nanak Khalsa College</h3>
            <p className="text-gray-300">Bachelor of Science in Information Technology (2017–2020)</p>
